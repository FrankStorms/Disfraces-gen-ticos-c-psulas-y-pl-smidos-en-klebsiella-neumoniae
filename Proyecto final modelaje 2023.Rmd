...
Variables d1/rho : Bacteria sin cápsula d2/rho1: Bacteria con cápsula 1 d2/rho2: Batería con cápsula 2

Parámetros alfa: Tasa de Fitness C: Límite de nutrientes gamma: Tasa de conjugación del plásmido rhoe: Tasa de pérdida del plásmido delta: Porción de bacterias que al dividirse se quedan sin plásmidos delta1: Tasa de muerte natural lamda: Tasa de muerte por fagos
...
\dot{d2} &=& (1-\delta)\alpha C \rho 1+ \gamma \rho \rho1 - \rho e (1-\delta) \alpha C \rho 1 - \delta 1 \rho 1 -  \lambda  \rho1\\ 
\dot{d3} &=& ((1- \delta)-\sigma)\alpha C \rho 2 + \gamma \rho \rho 2 - \rho e ((1-\delta)- \sigma)\alpha C \rho 2 -\delta 1 \rho 2 -  \lambda  \rho2
\end{aligned}
$$
